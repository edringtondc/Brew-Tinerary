...
const BreweryListItem = (props) => {
  return (
        ...
        <StyledCard body key={props.id}>
          ...
          <Button className="mx-2 mt-1" color="warning" onClick={()=> props.handleSave(props.id, props.url, props.name, props.status, props.street, props.city, props.state)}>Select</Button>
        </StyledCard>
